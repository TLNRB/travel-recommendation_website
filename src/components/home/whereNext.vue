<template>
  ...
  <div class="container-fluid w-full flex flex-col justify-center bg-white">
    <button @click="reshuffle"
      ...
      <svg :class="['h-4 w-4', isShuffling ? 'animate-spin' : '']" fill="none" stroke="currentColor" stroke-width="2"
        viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-2 mx-auto lg:grid-cols-4 gap-4 px-10 pt-4 pb-10">
      <div v-for="country in displayedCountries" :key="country.objectId" @click="goToCountry(country.objectId)"
